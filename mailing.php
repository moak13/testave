...
class Mailing {
	...
	public function mail_verification($email, $token) {
		...
		$this->mail->Port = 587;
		$this->mail->setFrom('ave@fstackdev.net', 'College Week Voting  - Verification Email');
		...
		$this->mail->Subject = 'College Week Voting 2018';
		$this->mail->From = "ave-voting@fstackdev.net";
		$this->mail->FromName = "ave voting platform";
				                                        ...
				                                        <td style="font-family: "Helvetica Neue",Helvetica,Arial,sans-serif;font-size: 23px;line-height: 28px"> 
				                                          <div style="font-size: 23px;color: #313131;font-weight: bold;text-decoration: none">
				                                            <div style="text-align: center">
				                                              <strong>Welcome to Landmark University Voting Site</strong>
				                                            </div>
				                                          </div> 
				                                        </td> 
				                                      </tr> 
				                                    ...
				                                    <tbody>
				                                      <tr> 
				                                        <td style="font-family: "Helvetica Neue", Arial, Helvetica, sans-serif;color: #808285;font-size: 13px;line-height: 19px;font-weight: bold" align="center" valign="top">
				                                          <a href="http://ave.fstackdev.net" target="_blank" style="color: #808285;text-decoration: none" rel="external nofollow noopener noreferrer" tabindex="-1">CSE DEV COMMITY</a>
				                                        </td> 
				                                      </tr> 
				                                    </tbody>
				                                  </table> 
